  ...
  background-size: cover;
    ...
    <form method="post" action="user_changePassword.jsp">
        ...
        <table class="tbl">
           ...
           <tr><td></td><td><input type="Submit" value="Change Password" class="btn"style="font-size:10pt;color:white;background-color:green;border:3px solid #336600;padding:4px"/></td></tr>
           </table>
