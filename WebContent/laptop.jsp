 ...
 try
    ...
    <center>
        <form action="laptop.jsp" method="post" onsubmit="return validateForm();" name="myForm" >
            ...
            <tr > <td>                  </td><td> <input type="submit" value="Add for sale!!" class="btn"style="font-size:10pt;color:white;background-color:green;border:3px solid #336600;padding:4px" /></td></tr>
           </center> </table>
        </form> 
    </center>
