...
<html>
  ...
  background-size: cover;
    ...
    <body>
    <center> <h3 style="margin-top:40px;">User Registration Form</h3></center>
    <center> 
        <form method="post" action="user_register.jsp"    >
           ...
           <tr><td></td><td> <input type="submit" value="Register" class="btn"       onclick="Javascript:checkEmail();"style="font-size:10pt;color:white;background-color:green;border:3px solid #336600;padding:4px"></td></tr>
            </table>
        </form>
