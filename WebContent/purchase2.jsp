    ...
    <center>
        <form method="post" action="purchase2.jsp" onsubmit="return validateForm();" name="myForm">
           ...
           <tr>  <td> City</td><td><input type="text" name="t5" class="btn"></td></tr>
            ...
            <tr>  <td>   </td><td>  <input type="submit" value="Confirm Material" class="btn"style="font-size:10pt;color:white;background-color:green;border:3px solid #336600;padding:4px" /></td></tr>
