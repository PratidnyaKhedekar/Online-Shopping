       ...
       <%@include file="connect.jsp" %>  
        ...
        <form method="post" action="admin_update.jsp" onsubmit="return validateForm();" name="myForm" >
           ...
           <tr>  
            ...
            <tr><td></td><td> <input type="submit" value="Update" class="btn"style="font-size:10pt;color:white;background-color:green;border:3px solid #336600;padding:4px"></td></tr>
            </table>
        </form>
    </center>
        ...
        <form method="post" action="admin_profile.jsp">
            <input type="submit" value="Go to Profile"style="font-size:10pt;color:white;background-color:green;border:3px solid #336600;padding:4px">
        </form>
        ...
        <form method="post" action="admin_itemPurchaseOrder.jsp">
            <input type="submit" value="ItemPurchaseOrder"style="font-size:10pt;color:white;background-color:green;border:3px solid #336600;padding:4px" >
        </form>
        ...
        <form method="post" action="admin_itemSale.jsp">
            <input type="submit" value="Product to sale"style="font-size:10pt;color:white;background-color:green;border:3px solid #336600;padding:4px">
        </form>
