...
function validateForm() {
   ...
   <h3>Welcome to Laptop Market</h3>
    ...
    <center> <table style="border:0px solid black;width:80%;" > <tr style="background-color:black;color:white;"> <td>Brand</td><td>  Specification</td><td> Price </td><td>Product ID</td></tr> 
...
<%
   try
   {
            ...
            <table>
                <tr>
                    <td><h1 >   Enter Product ID: <input type="text" name="t1"></h1></td><td>
                        <input type="submit" value="Purchase" class="btn"style="font-size:10pt;color:white;background-color:green;border:3px solid #336600;padding:4px" /></td></tr>
            </table>
        </form>
        ...
        <form method="post" action="clothsMarket.jsp">
            ...
            <input type = "Submit" value="Go To Cloths market"style="font-size:10pt;color:white;background-color:green;border:3px solid #336600;padding:4px" />
        </form></td><td>
