...
<html>
    ...
    <form action="purchase.jsp" method="post">
        <table>
            <th><h1></>Select Payment Mode</h1></th> 
            ...
            <tr><td>Cash on delivery</td><td><input type="radio" name="x" value="offline"></td></tr>
             <tr><td>   </td><td>    <input type="submit" value="DoPayment"style="font-size:10pt;color:white;background-color:green;border:3px solid #336600;padding:4px"></td></tr>    
        </table>     
     </form>  
    </body>
</html>